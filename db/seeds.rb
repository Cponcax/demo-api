...
Channel.create([{name: 'canal cuatro',streaming_url: 'streaming_url_canalcuatro', position: '4'}])

Schedule.create([{channel_id: 1 , date:'Thu, 18 Feb 2016 16:00:45 UTC +00:00', name: 'Programacion canal dos', turn: 'manana'}])

 Show.create([{name: 'Viva la manana' , rating: 'Para todo publico'}])

 Event.create([{show_id: 1, schedule_id: 1, start_time: 'Thu, 18 Feb 2016 12:00:00 UTC +00:00', end_time:'Thu, 18 Feb 2016 17:00:00 UTC +00:00', streaming_url:'streaming event',  }])
